...
export const followedUsersSelector = createSelector(peopleSelector, people => people.filter(u => u.followed));
export const unfollowedUsersSelector = createSelector(peopleSelector, people => people.filter(u => !u.followed));
